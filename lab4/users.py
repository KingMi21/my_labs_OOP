from protocols import DataChangingProtocol, DataChangedProtocol, PropertyChangedListenerProtocol
...
class User(DataChangedProtocol, DataChangingProtocol):
    ...
    def _validate_property_changing(self, property_name: str, old_value: Any, new_value: Any) -> bool:
        return all(listener.on_property_changing(self, property_name, old_value, new_value) for listener in
                   self.__data_changing_listeners)
